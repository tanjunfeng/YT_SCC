...
class OnSale extends Component {
    ...
    componentDidMount() {
        this.props.fetchSelfProduct({ pageSize: PAGE_SIZE, pageNum: this.current, shelfStatus: 1 })
    ...
    handlePaginationChange(goto) {
        this.current = goto;
        this.props.fetchSelfProduct({ pageSize: PAGE_SIZE, pageNum: goto, shelfStatus: 1 })
    }
    ...
    renderOperation(text, record, index) {
        ...
        const menu = (
            <Menu onClick={() => this.handleSelect(this, record, index)}>
                ...
                <Menu.Item key={2}>
                    <CopyToClipboard text={`${pathname}/${id}`} onCopy={this.onCopy}>
                        <span>复制链接</span>
                    </CopyToClipboard>
                </Menu.Item>
                <Menu.Item key={3}>
                ...
                <div className="gys-layout">
                    <Form layout="inline">
                        <div className="manage-form-item">
                            ...
                            <FormItem className="manage-form-item1">
                                <div>
                                    <span className="manage-form-label">下架时间</span>
                                    <RangePicker
                                        style={{ width: '270px' }}
